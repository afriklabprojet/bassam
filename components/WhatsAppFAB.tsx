...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2 px-4 py-3 text-white font-medium shadow-lg transition-opacity hover:opacity-90 active:opacity-80"
