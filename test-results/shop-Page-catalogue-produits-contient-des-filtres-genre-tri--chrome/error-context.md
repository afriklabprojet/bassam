...
- Name: shop.spec.ts >> Page catalogue produits >> contient des filtres (genre / tri)
- Location: e2e/shop.spec.ts:37:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/produits
Call log:
  - navigating to "http://localhost:3000/produits", waiting until "load"
