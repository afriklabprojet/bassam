...
const stats = [
  { value: '150+', label: 'Références en stock' },
  { value: '40+',  label: 'Maisons de luxe' },
...
const engagements = [
  { icon: '◆', titre: 'Traçabilité totale', texte: "Chaque produit est accompagné de son certificat d'authenticité et de son numéro de lot vérifiable." },
  { icon: '◆', titre: 'Emballage premium', texte: 'Coffrets signature, papier de soie et ruban or — votre commande arrive comme un cadeau.' },
  { icon: '◆', titre: 'Paiement sécurisé', texte: "Mobile Money, carte bancaire, Orange Money, Wave — nous acceptons tous vos moyens de paiement locaux." },
  { icon: '◆', titre: 'Livraison rapide', texte: "24 à 72h à Abidjan, 3 à 5 jours dans toute l\u2019Afrique de l\u2019Ouest." },
  { icon: '◆', titre: 'Service après-vente', texte: "Un problème\u00A0? Notre équipe répond en moins de 2h par WhatsApp, 7j/7." },
  { icon: '◆', titre: 'Conseil personnalisé', texte: "Pas sûr(e) de votre choix\u00A0? Notre quiz olfactif IA vous guide vers votre signature parfaite." },
];
      ...
      <section style={{ background: 'var(--offwhite)', padding: '96px 0' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 2 }} className="valeurs-grid">
            {valeurs.map((v, i) => (
              <div key={i} className="about-valeur" style={{
                background: '#fff',
                padding: '44px 36px',
                borderTop: i === 1 ? '2px solid var(--gold)' : '2px solid var(--line-light)',
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '80px', alignItems: 'start' }} className="engagements-grid">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
              {engagements.map((e, i) => (
                <div key={i} className="about-engagement" style={{
                  background: 'var(--offwhite)',
                  padding: '32px 28px',
                  borderLeft: '2px solid var(--line-light)',
                  transition: 'border-color 0.35s ease, transform 0.3s ease, background 0.3s ease',
                }}>
                  <span style={{ display: 'block', fontSize: '0.5rem', color: 'var(--gold)', marginBottom: 14, letterSpacing: 2 }}>{e.icon}</span>
                  <h3 style={{
                    fontFamily: 'var(--font-sans)',
                    fontSize: '0.875rem',
                    fontWeight: 600,
