...
const TEMOIGNAGES = [
  { name: 'Adjoua M.',  ville: 'Abidjan, Cocody',    texte: "Livré le lendemain matin, emballage magnifique et 100% authentique. Je ne commande plus ailleurs." },
  { name: 'Ibrahim K.', ville: 'Abidjan, Yopougon',  texte: "Ils m'ont aidé par WhatsApp à choisir entre deux parfums. Prix correct, livraison rapide. Recommandé !" },
  { name: 'Fatou B.',   ville: 'Bouaké',             texte: "Coco Mademoiselle reçu en 48h à Bouaké. Flacon parfait, prix bien meilleur qu'en boutique." },
];
...
export default async function HomePage() {
  ...
  const [{ products: rawBestSellers }, genderCounts] = await Promise.all([
            ...
            {TEMOIGNAGES.map((t) => (
              ...
              >
                ...
                <div style={{ display: 'flex', gap: '0.2rem' }}>
                  {[1, 2, 3, 4, 5].map((n) => (
                    <svg key={n} width="13" height="13" viewBox="0 0 24 24" fill="var(--gold)" stroke="none">
