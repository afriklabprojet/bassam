...
- Name: shop.spec.ts >> Page À propos >> se charge sans erreur
- Location: e2e/shop.spec.ts:151:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/a-propos
Call log:
  - navigating to "http://localhost:3000/a-propos", waiting until "load"
