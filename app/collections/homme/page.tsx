...
// ─── Testimonials ─────────────────────────────────────────────────────────────
const TEMOIGNAGES = [
  { auteur: 'Kofi B.', ville: 'Abidjan', texte: 'Sauvage Elixir livr\u00e9 en 24h, authentique et bien emball\u00e9. Je l\u2019ai command\u00e9 trois fois. Service imbattable.' },
  { auteur: 'Ibrahim T.', ville: 'Dakar', texte: 'Bleu de Chanel EDP perfect pour le bureau. Tenue toute la journ\u00e9e. L\u2019\u00e9quipe a su me conseiller le bon format.' },
];
          ...
          <div className="homme-temo-grid">
            {TEMOIGNAGES.map((t, i) => (
              <div key={i} style={{ background: 'var(--noir)', padding: '2rem', borderLeft: '2px solid var(--gold)' }}>
                ...
                <div>
                  <span style={{ fontFamily: 'var(--font-sans)', fontSize: '0.7rem', color: 'var(--gold)', fontWeight: 500 }}>{t.auteur}</span>
