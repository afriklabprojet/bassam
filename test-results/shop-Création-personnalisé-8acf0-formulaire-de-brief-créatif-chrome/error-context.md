...
- Name: shop.spec.ts >> Création personnalisée >> affiche le formulaire de brief créatif
- Location: e2e/shop.spec.ts:143:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/services/creation-personnalisee
Call log:
  - navigating to "http://localhost:3000/services/creation-personnalisee", waiting until "load"
