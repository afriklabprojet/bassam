...
- Name: admin.spec.ts >> /admin/alertes-stock redirige vers login si non authentifié
- Location: e2e/admin.spec.ts:71:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/admin/alertes-stock
Call log:
  - navigating to "http://localhost:3000/admin/alertes-stock", waiting until "load"
