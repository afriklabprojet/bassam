...
- Name: shop.spec.ts >> Quiz olfactif >> le bouton Suivant est désactivé sans sélection
- Location: e2e/shop.spec.ts:93:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/services/quiz-olfactif
Call log:
  - navigating to "http://localhost:3000/services/quiz-olfactif", waiting until "load"
