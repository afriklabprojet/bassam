...
- Name: shop.spec.ts >> Pages légales >> /confidentialite se charge sans erreur
- Location: e2e/shop.spec.ts:159:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/confidentialite
Call log:
  - navigating to "http://localhost:3000/confidentialite", waiting until "load"
